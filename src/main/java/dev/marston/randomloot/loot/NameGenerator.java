...
public class NameGenerator {
	...
	public static final String[] HotAdj = new String[] {
			"Flaming",
			"Scorched",
			"Schorching",
			"Red-Hot",
	...
	public static final String[] ColdAdj = new String[] {
			"Freezing",
			"Chilly",
			"Frozen",
			"Artic",
	...
	public static final String[] TemperateAdj = new String[] {
			"Temperate",
			"Agreeable",
			"Collected",
			"Fair",
	...
	public static final String[] RainingAdj = new String[] {
			"Wet",
			"Damp",
			"Gloomy",
			"Sad",
	...
	public static final String[] ColdNames = new String[] {
			"Boreas",
			"Borias",
			"Frostis",
			"Wintor",
	...
	public static final String[] TemperateNames = new String[] {
			"Heartha",
			"Trunken",
			"Plenta",
			"Lushious",
	...
	public static final String[] HotNames = new String[] {
			"Blazicus",
			"Dante",
			"Fyrus",
			"Pyrok",
